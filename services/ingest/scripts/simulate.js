 ...
 * Reads a fixture file and POSTs it to the local agent service directly,
 * bypassing Pub/Sub for faster iteration.
 *
 * Usage:
...
const typeMap = {
  gmail: 'gmail.email_received',
  slack: 'slack.message',
  calendar: 'calendar.event_upcoming',
}
